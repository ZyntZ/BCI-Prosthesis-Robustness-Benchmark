...
def test_methods_figures_are_generated_from_existing_csvs(tmp_path):
    ...
    assert manifest["note"].startswith("Figures are generated from committed participant-level results")
    assert set(manifest["outputs"]) == {"pipeline_schematic", "robustness_degradation"}
